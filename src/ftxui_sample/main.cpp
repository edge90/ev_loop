...
// configuration step. It creates a namespace called `ev_loop`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", ev_loop::cmake::project_name, ev_loop::cmake::project_version) };
